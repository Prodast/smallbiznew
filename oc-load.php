...
if( !file_exists(ABS_PATH . 'config.php') ) {
    ...
    $title   = 'Osclass Evolution';
    $message .= '<p><a class="btn btn-info btn-md" href="' . osc_get_absolute_url() .'oc-includes/osclass/install.php"><span class="material-icons">arrow_right</span>Установить</a></p>';
...
if( !getBoolPreference('osclass_installed') && MULTISITE ) {
    ...
    $title    = 'Osclass Evolution &raquo; Ошибка';
    $message  = '<p>Osclass не установлен. <a href="https://4osclass.net/">Нужна помошь?</a></p>';
    $message .= '<p><a class="btn btn-info btn-md" href="' . osc_get_absolute_url() .'oc-includes/osclass/install.php"><span class="material-icons">arrow_right</span>Установить</a></p>';
