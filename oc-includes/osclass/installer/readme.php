...
<head>
    ...
    <title>Osclass Evolution - Readme</title>
...
<div id="wrapper">
    <div id="container">
        <div id="header" class="readme">
            <h1 id="logo">
                    <img src="<?php echo osc_getAbsoluteWebURL(); ?>/oc-includes/images/osclass-logo.png" alt="Osclass Evolution" title="Osclass Evolution" />
        ...
        <div id="content">
            <div id="introduction">
                ...
                <div class="space-left-10">
                    <p>
Osclass Evolution- это CMS сайта объявлений с открытым исходным кодом. В несколько шагов вы можете создать
доску объявлений. Некоторые функции: простая установка, многоязычность, расширяемость через плагины,
дружественная для поисковых систем (sitemap, robots, urls seo-friendly) и многое другое.
                    </p>
                </div>
            </div>
            <div id="install">
                ...
                <div class="space-left-10">
                    ...
                    <ol>
                        <li>Загрузите и распакуйте пакет Osclass Evolution .</li>
                        <li>Перенесите распакованные файлы в нужное место на вашем сервере.</li>
                        <li>Выполните скрипт установки, обратившись к url <code>oc-includes/osclass/install.php</code> из вэббраузера:
                            <ul>
                                <li>Если вы установили Osclass Evo в корневой каталог домена, вам придется перейти к: <code>https://вашдомен/oc-includes/osclass/install.php</code></li>
                                <li>Если вы установили в папку внутри домена, <em>papka</em>, к примеру, прейдите к: <code>https://вашдомен/papka/oc-includes/osclass/install.php</code></li>
                            </ul>
                        </li>
                        <li>Следуйте инструкциям установщика:
                            <ul>
                                ...
                                <li>Шаг 3: Выберите категории, которые Вы хотите использовать н сайте. Или Вы можете это сделать позже из панели администратора.</li>
            ...
            <div id="upgrade">
                ...
                <p>
Osclass Evolution покажет сообщение о доступности обновления в панели администратора, если доступна новая (и стабильная) версия. Для начала обновления нужно только следовать инструкциям.
...
файл ядра то он, вероятно, будет заменен новым файлом. Будь осторожны)
                ...
                <div class="space-left-10"><h3 style="border-bottom: 1px solid grey;color: #444444;">Автообновление</h3>
                    ...
                    <ul>
                        <li>Шаг 1: Будет проверять доступна ли новая версия Osclass Evo.</li>
...
                     новаю версию вашего любимого программного обеспечения для сайта объявлений с открытым исходным кодом. Вы ожидали большего количества шагов или сложных инструкций? Сожалею! Но это легко.
                ...
                <div class="space-left-10"><h3 style="border-bottom: 1px solid grey;color: #444444;">Ручное обновление</h3>
                    <p>
Вы также можете обновить Osclass Evolution, загрузив пакет обновления, разархивируйте его и замените файлы на своем сервере теми, что есть в пакете.
            ...
            <div id="resources">
                ...
                <div class="space-left-10">
                    ...
                    <dl class="space-left-25">
                        <dt><a href="https://osclass.pro" title="<?php echo('Osclass Русское сообщество'); ?>" target="_blank">https://osclass.pro</a></dt>
                        <dd>
Здесь различная информация по Osclass Evo.
                        </dd>
                        <dt><a href="https://4osclass.net" title="<?php echo('Osclass Форум русский'); ?>"target="_blank">https://4osclass.net</a></dt>
                        <dd>
