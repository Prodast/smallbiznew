 ...
 */
    ...
    Class ItemActions
    {
        ...
        public function add()
        {
            ...
            if ($flash_error) {
                ...
                $this->manager->insert(array(
                    ...
                    's_contact_mobile'       => $aItem['contactMobile'],
                    's_secret'              => $code,
                    'b_active'              => ($active == 'ACTIVE' ? 1 : 0),
                    'b_enabled'             => $enabled,
                    'b_show_email'          => $aItem['showEmail'],
                    'b_show_mobile'          => $aItem['showMobile'],
                    'b_spam'                => $is_spam,
                    's_ip'                  => $aItem['s_ip']
                ));
        ...
        public function prepareData( $is_add )
        {
            ...
            $aItem['userId']        = $userId;
            $aItem['contactMobile']  = Params::getParam('s_phone_mobile');
            ...
            $aItem['showMobile']     = (Params::getParam('showMobile') != '') ? 1 : 0;
            $aItem['title']         = Params::getParam('title');
            if($this->is_admin && osc_editor_enabled_at_items()) {
