                        ...
                        <footer class="footer">
                            <div class="container">
                                <nav class="float-left">
                                    <ul>
									<li>
                            <a href="<?php echo osc_get_absolute_url(); ?>/oc-includes/osclass/installer/readme.php" target="_blank" hreflang="ru" ><?php echo('Прочти меня'); ?></a>
                        </li>
									<li>
                        <a href="https://osclass.pro/" title="<?php echo('Osclass Русское сообщество'); ?>" target="_blank">
                            <?php echo('Русское сообщество'); ?>
                        </a>
                    </li>
                           <li>
                        <a href="https://4osclass.net" title="<?php echo('Форум'); ?>" target="_blank">
                            <?php echo('Форум'); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://osclass-pro.ru/" title="<?php echo('Маркет'); ?>" target="_blank">
                            <?php echo('Маркет'); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://osclass.pro/dokumentaciya/" title="<?php echo('Документация'); ?>" target="_blank">
                            <?php echo('Документация'); ?>
                        </a>
                    </li>
                                        <li>
                                            <a id="ninja" href="javascript:;" title="<?php echo 'Помочь проекту'; ?>">
                                                <?php echo 'Помочь проекту'; ?>
                                            </a>
                                        </li>
                                    </ul>
                                </nav>
