    ...
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                <a href="https://osclass-pro.ru/themes/" target="_blank" class="btn btn-rose btn-block btn-fill">
                    <?php _e('Osclass Themes'); ?>
                </a>
                <a href="https://osclass-pro.ru/plugins/" target="_blank" class="btn btn-info btn-block">
                    <?php _e('Osclass Plugins'); ?>
                </a>
                <a href="https://osclass-pro.ru/" target="_blank" class="btn btn-success btn-block">
                    <?php _e('Want to sell your products?'); ?>
                </a>
                <a href="https://4osclass.net/index.php/board,19.0.html" target="_blank" class="btn btn-warning btn-block">
                    <?php _e('Suggestions'); ?>
                </a>
                <a href="https://4osclass.net" target="_blank" class="btn btn-dark btn-block">
                    <?php _e('Bugs Report'); ?>
                </a>
            </li>
        </ul>
...
<?php if(!getPreference('intro_msg')): ?>
    ...
    <div id="intro">
        ...
        <p class="mb-1"><?php printf(__('Therefore, please report all bugs you found to us on our forum: %s'), '<a href="https://4osclass.net" target="_blank">' . __('Bugs Report') . '</a>'); ?></p>
        <p class="mb-1"><?php printf(__('If you want to see new features here, please write to us on this page: %s'), '<a href="https://4osclass.net/index.php/board,19.0.html" target="_blank">' . __('Suggestions') . '</a>'); ?></p>
        <p class="mb-1"><?php printf(__('For all other questions, we will be glad to see you on our forum: %s or write to us by E-mail: %s'), '<a href="https://4osclass.net" target="_blank">' . __('Forum') . '</a>', '<a href="mailto:support@osclass-evo.com" target="_blank">' . __('support@osclass-evo.com') . '</a>'); ?></p>
...
<?php if(getPreference('osclass_evo_installed')): ?>
    ...
    <?php if($interval->format('%a') >= 30 && !getPreference('rate_us_msg')): ?>
        ...
        <div id="rate_us">
            ...
            <p class="mb-1"><?php printf(__('Please leave your feedback and rate the Osclass Evolution on this page: %s'), '<a href="https://4osclass.net/index.php/board,19.0.html" target="_blank">' . __('Post Feedback') . '</a>'); ?></p>
            ...
            <p class="mb-1"><?php printf(__('If you find a bug, let us know about it in our forum: %s'), '<a href="https://4osclass.net" target="_blank">' . __('Bugs Report') . '</a>'); ?></p>
            <p class="mb-1"><?php printf(__('If you want to see new features here, please write to us on this page: %s'), '<a href="https://4osclass.net/index.php/board,19.0.html" target="_blank">' . __('Suggestions') . '</a>'); ?></p>
            <p class="mb-1"><?php printf(__('For all other questions, we will be glad to see you on our forum: %s or write to us by E-mail: %s'), '<a href="https://4osclass.net" target="_blank">' . __('Forum') . '</a>', '<a href="mailto:support@osclass-evo.com" target="_blank">' . __('support@osclass-evo.com') . '</a>'); ?></p>
            <p class="mb-1"><?php _e('If you liked our work, buy us some beer - we will be very grateful:'); ?> <a id="ninja" href="javascript:;"><?php _e('Donate to us'); ?></a> :)</p>
            <hr class="mb-2">
