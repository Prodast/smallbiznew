                    ...
                    <div class="container">
                        ...
                        <a href="https://osclass.pro/" title="<?php echo('Osclass Русское сообщество'); ?>" target="_blank">
                            <?php echo('Русское сообщество'); ?>											  
                                ...
                                <li>
                            <a href="https://4osclass.net" title="<?php _e('Forum'); ?>" target="_blank">
                                <?php _e('Forum'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="https://osclass-pro.ru/" title="<?php _e('Osclass Шаблоны и Плагины'); ?>" target="_blank">
                                <?php _e('Osclass Маркет'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="https://osclass.pro/dokumentaciya/" title="<?php _e('Documentation'); ?>" target="_blank">
